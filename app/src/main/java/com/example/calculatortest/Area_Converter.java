...
public class Area_Converter extends AppCompatActivity {
    ...
    private double meterToCentimeter = 10000.00;
    private double meterToMillimeter = 1000000.00;
    private double meterToKilometer = 0.000001;
    private double meterToHectare = 0.0001;
    private double meterToAcre = 0.000247;
    private double meterToMeter = 1.00;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_area__converter);
                ...
                if (!inputTxtView.getText().toString().equals("")){
                    ...
                    switch (strInput) {
                        ...
                        case "Kilometer\u00b2":
                            ...
                            break;
                        case "Hectare":
                            toPrint = d1 / meterToHectare;
                            break;
                        case "Acre":
                            toPrint = d1 / meterToAcre;
                            break;
                    }
